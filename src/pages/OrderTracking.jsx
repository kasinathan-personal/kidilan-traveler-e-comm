...
const orderItems = [
  { product: allProducts[6], meta: 'Color · Brown | Size · XXL', qty: 4 },
  { product: allProducts[7], meta: 'Color · Cream | Size · XXL', qty: 1 },
  { product: allProducts[5], meta: 'Color · Light Brown | Size · S', qty: 1 },
  { product: allProducts[19], meta: 'Color · Brown | Size · S', qty: 2 },
];
